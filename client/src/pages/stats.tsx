    ...
    <div className="max-w-[1800px] mx-auto px-8 lg:px-16 pt-36 pb-40">
      ...
      >
        <div className="space-y-4 text-left">
          ...
          <p className="text-white/20 font-black text-sm uppercase tracking-[0.4em] italic leading-none">
            Precision analysis of workspace trajectory and intentional output vector.
          </p>
        </div>
      ...
      >
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-10 mb-20 bg-white/[0.02] border border-white/[0.05] p-10 rounded-[3rem] inline-flex">
            ...
            <div>
              <h2 className="text-4xl font-black tracking-[-0.03em] text-white">Trend Synthesis</h2>
              <p className="text-[10px] font-black uppercase tracking-[0.4em] text-white/10 mt-1 italic">Vocalizing workspace dynamics through tonal analysis</p>
            </div>
          </div>
    ...
    >
      <div className="flex flex-col h-full justify-between gap-12 relative z-10">
        <div className="flex items-center justify-between">
          <div className={cn("p-6 rounded-2xl border transition-all duration-700 group-hover:rotate-[15deg] group-hover:scale-110 shadow-2xl", colorMap[color])}>
            {icon}
          </div>
          <ArrowUpRight className="w-5 h-5 text-white/5 opacity-0 group-hover:opacity-100 transition-all duration-700 translate-x-4 group-hover:translate-x-0 group-hover:text-primary" />
        </div>
        
        <div className="space-y-4">
          <p className="text-[10px] font-black uppercase tracking-[0.4em] text-white/10 italic">{title}</p>
          <h3 className="text-7xl font-black tracking-[-0.08em] text-white leading-none">{value}</h3>
        </div>
        
        <div className="text-[10px] font-black uppercase tracking-[0.4em] text-white/10 pt-10 border-t border-white/[0.03] italic">
          {footer}
        </div>
      </div>
    </motion.div>
