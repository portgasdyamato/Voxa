    ...
    <div className="max-w-[1800px] mx-auto px-6 md:px-12 lg:px-24 pt-12 md:pt-20 pb-44">
      ...
      >
        ...
        <div
          ...
          className="relative flex items-center p-1 rounded-full border border-white/[0.12] bg-white/[0.03] backdrop-blur-[40px] self-start lg:self-auto shadow-lg"
        >
          {/* Single pill that slides — never unmounts */}
          <motion.div
            className="absolute top-1 bottom-1 rounded-full bg-white/[0.1] border border-white/[0.2] shadow-inner pointer-events-none"
          ...
          {periods.map((p, i) => (
            <button
              ...
              className={cn(
                'relative h-9 px-8 rounded-full text-sm font-medium transition-colors duration-150 z-10 whitespace-nowrap',
